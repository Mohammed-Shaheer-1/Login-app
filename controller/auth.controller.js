...
exports.getUserDetails = async (req, res) => {
    ...
    try {
        ...
        let query = `SELECT d.id, d.first_name, d.last_name, d.mobile,d.profile,d.address,d.email
            FROM details AS d
            WHERE d.userId = ${userId}`
...
exports.checkEmail = async (req,res)=>{
    try{
        await mail.SendGeneratedOTPCode('shanshaheer3@gmail.com',12345).then((result)=>{
            console.log(result);
        }).catch((err)=>{
            console.log(err);
        })
